        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <a class="navbar-brand" href="{{ route('discussion.index') }}">
                    ...
                    <a href="{{ route('users.notifications') }}" class="btn btn-success btn-sm">
    ...
    <main class="container py-4">
        <div class="row">
            <div class="col-md-4">
                <ul class="list-group">
                    @auth
                    <a href="{{ route('discussion.create') }}" class="btn btn-primary btn-sm mb-2">Add Discussion</a>
                    @else
                    <a href="{{ route('login') }}" class="btn btn-primary btn-sm mb-2">Login to make discussion</a>
                    @endauth
                    <div class="card">
